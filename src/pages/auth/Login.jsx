...
const Login = () => {
  return (
    ...
    <div class=" top-32 relative py-3 sm:max-w-xl sm:mx-auto w-full">
    <div
    ...
    >
      <div class="max-w-md mx-auto text-white">
        ...
        <h1 className='text-3xl  '>L<span className='bg-gradient-to-r from-orange-500 to-orange-800 text-transparent bg-clip-text'>a</span>L<span className='bg-gradient-to-r from-orange-500 to-orange-800 text-transparent bg-clip-text'>a</span> k<span className='bg-gradient-to-r from-orange-500 to-orange-800 text-transparent bg-clip-text'>U</span></h1>
        </div>
        <div class="mt-5">
          <label
            for="login"
        ...
        <div class="mt-5">
          <button
            type="submit"
            class="py-2 px-4 bg-gradient-to-r from-orange-500 to-orange-800 hover:bg-orange-900 focus:to-orange-500 focus:to-orange-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg"
          >
            Log in
          </button>
        </div>
